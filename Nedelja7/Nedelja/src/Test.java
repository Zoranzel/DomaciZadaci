...
import rs.itbootcamp.dao.UserDaoSQL;
import rs.itbootcamp.model.FoodModel;

public class Test {
	
	public static void main(String[] args) {
	FoodDaoSQL fds = new FoodDaoSQL();
	
//	FoodModel fm = new FoodModel(30, "Boranija", 322.90, 21.20, 30.50, 15.90);
